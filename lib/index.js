...
export default class PhoneInput extends PureComponent {
  ...
  setPhoneNumber = (phoneNumberWithCode) => {
    try {
      ...
      // Try to parse number and extract country code
      try {
        const parsedNumber = phoneUtil.parse(cleanNumber);
        ...
        // Update state with country code info
        this.setState(
          {
          ...
          () => {
            if (this.props.onChangeFormattedText) {
              this.props.onChangeFormattedText(phoneNumberWithCode);
            }
          }
        );
      } catch (parseErr) {
        ...
        this.setState(
          ...
          () => {
            if (this.props.onChangeFormattedText) {
              this.props.onChangeFormattedText(cleanNumber);
            }
          }
        );
      }
